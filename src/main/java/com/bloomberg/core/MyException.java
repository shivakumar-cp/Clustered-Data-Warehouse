...
public class MyException extends RuntimeException {
	...
	public MyException(RuntimeException innerExcep, String message) {

		super(message, innerExcep);
	}

	public MyException(RuntimeException innerExcep, String format, Object... args) {

		super(String.format(format, args), innerExcep);
	}

	public MyException(Exception innerExcep, String message) {

		super(message);
		this.innerExcep = innerExcep;
	}

	public MyException(Exception innerExcep, String format, Object... args) {
